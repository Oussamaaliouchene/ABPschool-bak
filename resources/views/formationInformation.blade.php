            ...
            <div class="row  gy-10 " style="height: 90%;">
                ...
                <div class=" w-100  container border background" style=" height: 90%;overflow: scroll;border-radius: 20px;">
                        <div class=" p-4 mb-1  ms-1 me-1  row">
                            ...
                            <h1 class="mb-4 fs-3 ">Formation a la carte</h1>
                            <p  class="mb-0" >Nom de la formation:</p>
                            <h2 class=" mb-4 fs-3">Education financiere</h2>
                            <p class="mb-2">Nom de l'enseignant:</p>
                            <h2 class=" mb-4 fs-3">Mahmoud Saidani</h2>
                            <p class="mb-2">Date et heure:</p>
                            <h2 class=" mb-4 fs-3">Samedi a 17:00</h2>
                            <p class="mb-0 mt-4">Prix d'un abonnement:</p>
                            <h1 class="fs-5">2000da</h1>
                            </div>
                           
                            <div class="second-side   col-md" >  
                                <p  class=" mt-4 mb-0 ">Promotions:</p>
                                <button type="button " class="formation-tag pb-1 pt-0 mt-1 mb-1 btn btn-outline-primary" style=" border-radius: 20px; height: 28px; justify-content: center; align-items: center;" disabled >
